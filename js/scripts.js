$(document).ready(function () {
    ...
    var myCalendar = createCalendar({
        ...
        data: {
            // Event title
            title: "Lễ cưới của Trung & Thư",

            // Event start date
            start: new Date('Dec 19, 2025 10:00'),
            ...
            // Event Description
            description: "Chúng mình rất mong được gặp bạn trong ngày trọng đại. Mọi thắc mắc vui lòng liên hệ chú rể (Trung) qua số điện thoại: 0384101606."
        }
    });
    ...
    $('#rsvp-form').on('submit', function (e) {
        ...
        if (MD5($('#invite_code').val()) !== 'b0e53b10c1f55ede516b240036b88f40'
            ...
            $('#alert-wrapper').html(alert_markup('danger', '<strong>Rất tiếc!</strong> Mã mời của bạn không đúng.'));
        } else {
            $.post('https://script.google.com/macros/s/AKfycbyo0rEknln8LedEP3bkONsfOh776IR5lFidLhJFQ6jdvRiH4dKvHZmtoIybvnxpxYr2cA/exec', data)
                .done(function (data) {
                    ...
                    if (data.result === "error") {
                        $('#alert-wrapper').html(alert_markup('danger', '<strong>Rất tiếc!</strong> ' + data.message));
                    } else {
                        $('#alert-wrapper').html('');
